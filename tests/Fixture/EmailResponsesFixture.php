...
class EmailResponsesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'email_responses_email_response_type_id' => ['type' => 'foreign', 'columns' => ['email_response_type_id'], 'references' => ['email_response_types', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
            'email_responses_email_send_id' => ['type' => 'foreign', 'columns' => ['email_send_id'], 'references' => ['email_sends', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
    ];

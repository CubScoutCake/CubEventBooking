...
class Initial extends AbstractMigration
{
    public function up()
    {
        ...
        $table
            ...
            ->addColumn('logisticstype_id', 'integer', [
                'default' => null,
                'limit' => 11,
                'null' => true,
            ])
        ...
        $table = $this->table('logisticstypes');
        $table
            ->addColumn('logistics_type', 'string', [
                'default' => null,
                'limit' => 45,
                'null' => true,
            ])
            ->addColumn('type_description', 'string', [
                'default' => null,
                'limit' => 999,
                'null' => true,
            ])
        ...
        $table
            ...
            ->addColumn('parameter_text', 'string', [
                'default' => null,
                'limit' => 255,
                'null' => true,
            ])

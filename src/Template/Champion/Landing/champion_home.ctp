            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>District Payments Received</div>
                    </div>
                </div>
            </div>
            <a href="<?php echo $this->Url->build([
                                            ...
                                            <td class="actions">
                                                <div class="dropdown btn-group">
                                                    ...
                                                    <ul class="dropdown-menu " role="menu">
                                                        ...
                                                        <li><?= $this->Html->link(__('Update'), ['prefix' => 'champion','controller' => 'Invoices','action' => 'regenerate', $invoice->id]) ?></li>
                                                    </ul>
                                                </div>
                                            </td>
                                            ...
                                            <td class="actions">
                                                <div class="dropdown btn-group">
                                                    ...
                                                    <ul class="dropdown-menu " role="menu">
                                                        ...
                                                        <li><?= $this->Html->link(__('Edit'), ['prefix' => 'champion','controller' => 'Payments','action' => 'edit', $payment->id]) ?></li>
                                                    </ul>
                                                </div>
                                            </td>

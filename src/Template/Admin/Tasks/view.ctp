...
<div class="tasks view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= $task->has('task_type') ? $this->Html->link($task->task_type->task_type, ['controller' => 'TaskTypes', 'action' => 'view', $task->task_type->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><?= __('Completed By User Id') ?></th>
            <td><?= $this->Number->format($task->completed_by_user_id) ?></td>
        </tr>
        <tr>

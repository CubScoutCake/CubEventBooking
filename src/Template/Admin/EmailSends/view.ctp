...
<div class="emailSends view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $emailSend->has('notification_type') ? $this->Html->link($emailSend->notification_type->id, ['controller' => 'NotificationTypes', 'action' => 'view', $emailSend->notification_type->id]) : '' ?></td>
        </tr>
        <tr>

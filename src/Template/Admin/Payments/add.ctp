...
/**
 *
 * @var int $numberOfInvAssocs
 * @var int $invId
 * @var int|string $invDefault
 * @var array $invoices
 *
 * @var \App\Form\PaymentAssocationForm $paymentAssocForm
...
<div class="row">
    <div class="col-md-12">
        <?php if (is_null($numberOfInvAssocs) || $numberOfInvAssocs < 1 || !isset($numberOfInvAssocs) ): ?>
            ...
            <br/>
            <hr/>
            <?= $this->Form->create($paymentAssocForm) ?>
                <fieldset>
        ...
        <?php else : ?>
            <?= $this->Form->create($payment) ?>
                <fieldset>
                    ...
                    for ($inv = 0; $inv < $numberOfInvAssocs; $inv ++) {

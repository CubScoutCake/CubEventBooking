...
<!-- Metis Menu -->
<?php echo $this->Html->css('https://cdn.jsdelivr.net/npm/metismenu@3.0.3/dist/metisMenu.min.css', ['integrity' => 'sha256-h/76VfocIFZUZihLOhNgPXg/wzQVptPo0oBa9ZqTQ7s=', 'crossorigin' => 'anonymous']); ?>

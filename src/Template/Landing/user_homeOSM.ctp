...
<div class="landing user_home large-10 medium-9 columns">
	<div>
		...
		<!-- OSM LINK IS NOT READY

		<div class="landing user_home large-4 medium-4 columns">

			<p>Or link to your OSM and pull in the data.</p>

			<ol>
				<li><?= //$this->Html->link(__('Link your OSM Account'), ['controller' => 'Osm', 'action' => 'link']) ?></li>
				<li><?= //$this->Html->link(__('Create an Application'), ['controller' => 'Applications', 'action' => 'add']) ?></li>
				<li><?= //$this->Html->link(__('Create an OSM Event'), ['controller' => 'Osm', 'action' => 'event']) ?></li>
				<li><?= //$this->Html->link(__('Pull in Attendees'), ['controller' => 'Osm', 'action' => 'attendees']) ?></li>
				<li><?= //$this->Html->link(__('Generate an Invoice'), ['controller' => 'Invoices', 'action' => 'generate']) ?></li>
			</ol>
		</div> -->
...
<div class="landing user_home large-12 medium-12 columns content">
	...
	<table class="goat" cellpadding="0" cellspacing="0">
        <tr class="goat">
			...
			<!-- <th class="goat"><?= // __('OSM Integration'); ?></th> -->
        ...
        <tr class="goat">
			...
			<!--<td class="goat"><?= //$this->Html->link('Integration Landing', ['prefix' => false, 'controller' => 'Osm', 'action' => 'home']); ?></td>-->
        ...
        <tr class="goat">
			...
			<!-- <td class="goat"><?= //$this->Html->link('Link to Your Account', ['prefix' => false, 'controller' => 'Osm', 'action' => 'link']); ?></td>-->
        ...
        <tr class="goat">
			...
			<!-- <td class="goat"><?= //$this->Html->link('Link to Your Section', ['prefix' => false, 'controller' => 'Osm', 'action' => 'section']); ?></td> -->
        ...
        <tr class="goat">
			<td class="goat"><?= //$this->Html->link('Create OSM Event', ['prefix' => false, 'controller' => 'Osm', 'action' => 'event']); ?></td>
			<td class="goat"><?= //$this->Html->link('Pull Attendees from OSM', ['prefix' => false, 'controller' => 'Osm', 'action' => 'attendees']); ?></td>
			<td class="goat"></td>
			<td class="goat"></td>
			<td class="goat"></td>
        </tr> -->
